...
@router.post(
    ...
    description="Upload a document (PDF, TXT, or CSV) to be processed and added to the vectore store",
)
...
async def upload_document(
    ...
    try:
        ...
        logger.warning(f"Invalid file uploaded: {e}")
...
@router.get(
    ...
    description="Get information abount the document collection",
)
...
@router.delete(
    ...
    description="Delete all documents from the vectore store. Use with caution",
)
